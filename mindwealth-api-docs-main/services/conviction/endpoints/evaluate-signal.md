...
```bash
curl -s -X POST http://localhost:8506/api/v1/conviction/signals/evaluate -H "Content-Type: application/json" -d '{"ticker":"AAPL","technical_signal":"BUY","signal_timeframe":"long"}' | jq
```
