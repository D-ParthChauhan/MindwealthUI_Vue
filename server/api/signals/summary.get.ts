import { loadSignalSummary, type SignalReportSlug } from '../../utils/mindwealth-data'
import { resolveApiData } from '../../utils/data-resolution'
import { getUnavailableSignalSummary } from '../../utils/unavailable-data'
...
export default defineEventHandler(async (event) => {
  ...
  return resolveApiData(
    await loadSignalSummary(slug, reportDate),
    () => getUnavailableSignalSummary(slug),
    () => getUnavailableSignalSummary(slug),
  )
})
