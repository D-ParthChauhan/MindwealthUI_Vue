...
**Source:** `macro_intelligence/output/runic_output.json`, `runic.db`, `ssi.db`, `positioning.json`
...
### New (v1.4.0) — SSI Endpoints

| Method | Path | operationId | Doc |
|--------|------|-------------|-----|
| GET | `/macro/ssi/summary` | `get_ssi_summary` | [get-ssi-summary.md](endpoints/get-ssi-summary.md) |
| GET | `/macro/ssi/history` | `get_ssi_history` | [get-ssi-history.md](endpoints/get-ssi-history.md) |
| GET | `/macro/ssi/multiplier` | `get_ssi_multiplier` | [get-ssi-multiplier.md](endpoints/get-ssi-multiplier.md) |
...
| SSI — Latest snapshot | `GET /macro/ssi/summary` |
| SSI — Time series chart | `GET /macro/ssi/history` |
| Position sizing (multiplier) | `GET /macro/ssi/multiplier` |
...
- SSI summary: [get-ssi-summary.md](endpoints/get-ssi-summary.md)
- SSI history series: [get-ssi-history.md](endpoints/get-ssi-history.md)
- SSI multiplier: [get-ssi-multiplier.md](endpoints/get-ssi-multiplier.md)
- Full nightly payload: [get-runic-nightly.md](endpoints/get-runic-nightly.md)
- Analytics sentiment layers: [get-sentiment-layers.md](../analytics/endpoints/get-sentiment-layers.md)
