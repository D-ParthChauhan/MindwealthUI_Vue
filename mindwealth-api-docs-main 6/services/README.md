...
Master index of all REST services in MindWealth_UI. **API version 1.5.0** — 75 operations.
...
| [Portfolio](portfolio/) | Implemented (v1.5.0) | `/api/v1/portfolio` | 4 | [README](portfolio/README.md) + [endpoints/](portfolio/endpoints/) |
...
| Portfolio — Sized Allocations | `/portfolio/sizer?scenario=normal\|stress\|lowvol` |
| Portfolio — Risk matrix | `/portfolio/risk` |
| Portfolio — Holdings analysis | `POST /portfolio/risk/analyze` |
| Portfolio — Ticker search | `/portfolio/risk/search?q=` |
