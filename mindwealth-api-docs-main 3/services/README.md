...
Master index of all REST services in MindWealth_UI. **API version 1.3.0** — 68 operations.
...
| [Macro / Runic](macro/) | Implemented (v1.3.0) | `/api/v1/macro` | 17 | [README](macro/README.md) + [endpoints/](macro/endpoints/) |
